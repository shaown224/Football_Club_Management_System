...
<div class="formcontentp" id="playerinfo">
    <form   class="f_inner" action="match_result_search.php" method="post">
...
<?php
  ...
  $con = new PDO("mysql:host=localhost;dbname=football_club",'root','');
	$sth = $con->prepare("Select  * from match_result order by match_id asc");
  ...
  ?>
  <header class="a" >
  UIU FC &nbsp; &nbsp; <?php echo $row->uiu_goal;?>  -  <?php echo $row->opp_goal;?> &nbsp; &nbsp; <?php echo $row->opponent_team_name;?> <br>
  </header>
